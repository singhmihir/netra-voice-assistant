...
(function () {
    ...
    function _dropDraftsOfTurn(b, turn) {
        ...
        if (b.plan && !b.plan.confirmed && b.plan.turn === turn) _dropPlanReadBack(b);
    }

    // a part-run plan whose "carry on?" read-back is dropped goes back to
    // stopped, not away - its finished steps stay undoable
    function _dropPlanReadBack(b) {
    ...
    function _dropUnheardDrafts(out) {
        ...
        if (b.plan && !b.plan.confirmed && b.plan.turn === cur) { _dropPlanReadBack(b); dropped++; }
