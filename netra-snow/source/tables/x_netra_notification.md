...
`/api/x_netra/voice/notifications`, which returns and marks each row as
delivered.
...
2. Label: **Netra Notification**, Name: `x_netra_notification`
3. Application: **Netra Voice Assistant** (`x_netra`)
