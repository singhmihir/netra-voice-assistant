...
(function () {
    ...
    SRC.stylesheet = ["/* ============================================================",
        ...
        "}",
        "",
        "/* Read-only ticket badge in the dev console header */",
        ".netra-dev-badge-ro {",
        "    font-family: 'JetBrains Mono', 'Consolas', monospace;",
        "    font-size: 8px;",
        "    font-weight: 700;",
        "    letter-spacing: 0.08em;",
        "    color: #9fe8c0;",
        "    background: rgba(46, 184, 88, 0.12);",
        "    border: 1px solid rgba(46, 184, 88, 0.45);",
        "    border-radius: 999px;",
        "    padding: 1px 7px;",
        "    white-space: nowrap;",
        "}",
        ...
        ".netra-dev-status b.ro { color: #9fe8c0; }",
