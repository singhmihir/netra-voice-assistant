...
(function () {
    ...
    SRC.template = ["<!--",
        ...
        "      <span class=\"netra-dev-ver\">R5</span>",
    ...
    SRC.stylesheet = ["/* ============================================================",
        ...
        "    color: #969696;",
        "}",
        ".netra-dev-x:hover { background: #094771; color: #ffffff; border-color: #007acc; }",
        ...
        "    border-color: #007acc;",
        "}",
        ".netra-dev button:active:not(:disabled) { background: #005a9e; }",
