...
(function () {
    ...
    SRC.template = ["<!--",
        "  Netra Mic widget template - R8.1 \"Prism\" (Claude-of-ServiceNow)",
        "",
        ...
        "        Full-screen Claude-Live-style voice surface: warm cream canvas,",
    ...
    SRC.server = ["/**",
        ...
        "                meaning: _UI_ACTION_MEANINGS[String(ua.action_name || '')] || null,",
        ...
        "        var meaning = _UI_ACTION_MEANINGS[String(ua.action_name || '')] || '';",
        "        var explanation = '';",
        ...
        "                    p.analyst_terms = ANALYST_LEXICON;",
        "                    return p;",
        "                }",
        "            }",
        "        } catch (e) { /* fall through to refresh */ }",
        "",
        "        var v = { groups: [], apps: [], categories: [], kb_titles: [], catalog_items: [], common: COMMON_VOCAB, analyst_terms: ANALYST_LEXICON, built_at: '' };",
        "",
        "        // Assignment groups",
        "        try {",
    ...
    SRC.stylesheet = ["/* ============================================================",
        ...
        " *",
        " *  Claude-Live-style full-screen voice surface: the stage is a",
        ...
        "",
        "/* the big blob - warm plasma clay, Claude-Live feel, Netra palette.",
        ...
        " * speaks (violet), the way Claude Live shifts warm tones. */",
